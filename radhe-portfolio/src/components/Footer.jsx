        ...
        <div className="glass-card footer-shell">
          <div className="footer-content">
            <div className="footer-brand">
              <h3 className="footer-logo">{config.developer.fullName}</h3>
          ...
          <div className="footer-bottom">
            <p className="copyright">© {currentYear} {config.developer.fullName}. Crafted in React.</p>
            <p className="made-with">Made with <FiHeart className="heart-icon" /> glassmorphism and clean engineering.</p>
          </div>
        </div>
      </div>
    </footer>
